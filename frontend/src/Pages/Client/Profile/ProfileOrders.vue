...
.item-qty { font-weight: 700; color: #E63B6F; margin-left: 6px; }
...
.page-btn:hover:not(:disabled) { background: #f1f5f9; color: #E63B6F; border-color: #E63B6F; }
...
.cancel-reason-item:hover { border-color: #E63B6F; background: #f0f9ff; }
.cancel-reason-item.selected { border-color: #E63B6F; background: #f0f9ff; }
