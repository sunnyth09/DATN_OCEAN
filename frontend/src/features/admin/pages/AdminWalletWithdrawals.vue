...
<template>
  <div class="admin-withdrawals-page">
    ...
    <div v-if="pagination && pagination.last_page > 1" class="pagination">
      <button class="page-btn" :disabled="pagination.current_page === 1" @click="fetchWithdrawals(pagination.current_page - 1)">«</button>
      <span>Trang {{ pagination.current_page }} / {{ pagination.last_page }} ({{ pagination.total }} kết quả)</span>
      <button class="page-btn" :disabled="pagination.current_page === pagination.last_page" @click="fetchWithdrawals(pagination.current_page + 1)">»</button>
    </div>
  </div>
</template>
