...
const slides = [
    {
        ...
        badge1: { icon: 'flame', title: 'Top 1 Trending', sub: 'Bộ sưu tập Hot nhất' },
        badge2: { icon: 'trophy', title: '4.9/5 Đánh giá', sub: 'Từ 15.000+ khách hàng' },
        badge3: { icon: 'tag', title: 'Ưu đãi tới 45%', sub: 'Số lượng có hạn' },
        accentColor: '#E63B6F'
    },
    {
        ...
        badge1: { icon: 'racket', title: 'Carbon Graphite', sub: 'Siêu nhẹ & Bền bỉ' },
        badge2: { icon: 'shield', title: 'Bảo hành 12 tháng', sub: 'Chính hãng 100%' },
        badge3: { icon: 'truck', title: 'Giao hỏa tốc 2H', sub: 'Nội thành TP' },
        accentColor: '#0ea5e9'
    },
    {
        ...
        badge1: { icon: 'shoe', title: 'Đệm khí Power Cushion', sub: 'Giảm chấn 40%' },
        badge2: { icon: 'rotate-ccw', title: 'Đổi size miễn phí', sub: 'Trong 30 ngày' },
        badge3: { icon: 'package', title: 'Tặng túi đựng giày', sub: 'Cho đơn từ 1Tr' },
        accentColor: '#10b981'
    }
];
                ...
                >
                    ...
                    <div class="hero-left">
                        <div class="hero-tag-pill">
                            <span class="hero-tag-icon"><AppIcon :name="slide.tagIcon" size="15" stroke-width="2.3" /></span>
                    ...
                    <div class="hero-right">
                        <div class="hero-visual-card">
                            ...
                            <div class="floating-badge badge-top-right">
                                <span class="f-icon"><AppIcon :name="slide.badge1.icon" size="20" stroke-width="2.2" /></span>
                                <div class="f-text">
                            ...
                            <div class="floating-badge badge-bottom-left">
                                <span class="f-icon"><AppIcon :name="slide.badge2.icon" size="20" stroke-width="2.2" /></span>
                                <div class="f-text">
                            ...
                            <div class="floating-badge badge-discount">
                                <span class="f-icon"><AppIcon :name="slide.badge3.icon" size="18" stroke-width="2.2" /></span>
                                <div class="f-text">
