                                    ...
                                    <div class="variant-bulk-bar">
                                        ...
                                        <div class="bulk-fields">
                                            <div class="bulk-input-group">
                                                ...
                                                <input type="text" inputmode="numeric" :value="formatNumberWithCommas(variant.bulkStock)" @input="onNumericInput($event, variant, 'bulkStock')" placeholder="Số lượng" class="form-control input-xs text-center" />
                                            </div>
                                            <div class="bulk-input-group">
                                                ...
                                                <tr class="size-main-row" :class="{'has-sale-active': s.has_sale}">
                                                    ...
                                                    <td>
                                                        <div class="stock-input-wrapper">
                                                            <input type="text" inputmode="numeric" :value="formatNumberWithCommas(s.stock)" @input="onNumericInput($event, s, 'stock')" class="form-control input-sm text-center" :class="{ 'is-invalid': errors.variants?.[vIndex]?.sizes?.[sIndex]?.stock, 'input-error': errors.variants?.[vIndex]?.sizes?.[sIndex]?.stock }" placeholder="0" />
                                                        </div>
