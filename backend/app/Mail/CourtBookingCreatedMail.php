...
class CourtBookingCreatedMail extends Mailable implements ShouldQueue
{
    ...
    {
        $this->booking = $booking->loadMissing(['court', 'user', 'services.service']);
    }

    public function envelope(): Envelope
    {
        return new Envelope(
            subject: '[Ocean Sport] Xác nhận yêu cầu đặt sân #'.$this->booking->booking_code,
        );
    }
